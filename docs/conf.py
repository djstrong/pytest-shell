# -*- coding: utf-8 -*-
#
# pytest-shell documentation build configuration file, created by
...
project = u'pytest-shell'
copyright = u'2015, Daniel Murray'
author = u'Daniel Murray'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-shell Documentation',
     [author], 1)
]
